...
export function AssistantResponse({
  ...
  const responseSchema = () => {
    ...
    if (assistantType === 'health') {
      return {
        inputPlaceholder: 'Describe your age, gender, symptoms, allergies, and your current medications for your disease.',
        agePlaceholder: 'Age',
  ...
  return (
    <>
      ...
      <View style={{ display: 'flex', gap: 14 }}>
        <View style={{ gap: 8 }}>
          <CustomText style={{ paddingHorizontal: 24 }}>{response!.titlePlaceholer}</CustomText>
